<?php
/**
Template Name: Home - Hero Background
 *
 * @package readit pro
 */
...
<?php if (has_post_thumbnail( $post->ID ) ): ?>
		...
		<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'max-control' );
			  $image = $image[0]; ?>
              
	<?php endif; ?>
    
<header class="entry-header hero-background" style="background-image: url('<?php echo $image; ?>');">
