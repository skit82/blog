...
?>
        ...
        <div class="notice notice-error uct-notice is-dismissible">
            <p>
                <?php printf( esc_html__( 'Please use a %s child theme to make changes', 'readit' ), $this->theme->get( 'Name' ) ); ?>
                <a class="uct-activate" href="javascript:;"><?php esc_html_e( 'Activate now', 'readit' ); ?></a> 
            </p>
        </div>
<?php
        }
        ...
        function activate_child_theme() {
            ...
            wp_die( esc_html__( 'All done!', 'readit' ) );
        }
        ...
        function create_child_theme() {
            ...
            if ( wp_mkdir_p( $child_dir ) ) {
                ...
                wp_die( esc_html__( 'Error: theme folder not writable', 'readit' ) );
            }
        }
